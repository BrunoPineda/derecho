...
<div class="container-fluid">
	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-6" href="lista_usuarios.php">
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-9 col-md-6 mb-6" href="lista_productos.php">
			<div class="card border-left-info shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Procesos</div>
							<div class="row no-gutters align-items-center">
								<div class="col-auto">
