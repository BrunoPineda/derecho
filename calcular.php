...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 //   $pregunta2a = isset($_POST["pregunta2a"]) ? intval($_POST["pregunta2a"]) : 0;
  ...
  //  $pregunta5a = isset($_POST["pregunta5a"]) ? intval($_POST["pregunta5a"]) : 0;
 ...
 //   $pregunta12a = isset($_POST["pregunta12a"]) ? intval($_POST["pregunta12a"]) : 0;
